function [mCov, coef_corr1, coef_corr2, numDatosClase1, numDatosClase2, numDatos, d1, d2, d12, coeficientes_d12, Acc1, Acc2] = funcion_Calculo_Clasificadores(X, Y, Tipo)
    close all
    ...
    %% DISEÑO DEL CLASIFICADOR MDE o MDM. Esta función está diseñada para ser universal
